...
{
    [TestFixture]
    public class _02LoadDataSet1 : DriverTestCase
    {
        [Test]
        public void loadDataSet1()
        {
            ...
            loadHelper.WaitForWorkArround(5000);
            //Select the checkbox highlighted (authority type row in the drop down column)
            ...
            //Enter the name “Heatmap UK Test” in the Dataset Name box
            ...
            loadHelper.WaitForTextVisible("Heatmap UK Test", 5000);
